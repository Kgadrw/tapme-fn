...
const leaders = [
  ...
  },
  {
    ...
    title: "Co-Founder and Head of Partnerships and Business Operations",
    image: "/team/jeovaire.png",
    alt: "Portrait of UMUKUNDWA Jeovaire, Co-Founder and Head of Partnerships and Business Operations",
  ...
  },
  {
    ...
    alt: "Portrait of NYANGOMA Jennifer, Head of Finance and Administration",
...
export function AboutPage() {
  return (
    <div className="bg-white">
      ...
      <section className="mx-auto max-w-[720px] px-5 pb-16 sm:px-8 sm:pb-20 md:pb-24">
        <FadeUp>
          ...
          {leaders.map((person) => (
            <motion.li key={person.name} variants={fadeUp}>
              <div className="group relative aspect-[3/4] overflow-hidden bg-[#e8e8ea] sm:aspect-[4/5]">
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/85 via-black/45 to-transparent pt-24 transition-all duration-500 group-hover:from-black/90 group-hover:via-black/55 group-hover:pt-36">
                  <div className="px-3 pb-4 text-left sm:px-4 sm:pb-5 md:px-5 md:pb-7">
                    <div className="translate-y-0 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:-translate-y-3 sm:group-hover:-translate-y-4">
                      <h3 className="text-[22px] font-semibold leading-tight tracking-tight text-white sm:text-[20px] md:text-[26px] lg:text-[30px]">
                        {person.name}
                      </h3>
                      <p className="mt-1.5 max-w-[22ch] text-[13px] font-medium leading-snug text-white/90 sm:mt-2 sm:text-[12px] md:text-[14px] lg:text-[15px]">
                        {person.title}
                      </p>
                    </div>
                    <p className="mt-0 max-h-0 overflow-hidden text-[12px] leading-relaxed text-white/85 opacity-0 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:mt-3 group-hover:max-h-48 group-hover:opacity-100 sm:text-[11px] md:group-hover:max-h-52 md:text-[13px]">
                      {person.bio}
                    </p>
                  </div>
                </div>
